 ...
 * </ul>
 */
public class OrderByRestrictedPrint implements Order {

  private final PrintElementRestricted PRINT_MODEL_ELEMENT;

  private final Map<RefBaseObject, String> elementToPrintOutMap = new IdentityHashMap<>();


  public OrderByRestrictedPrint(MatchingCriteria criteria) {
    PRINT_MODEL_ELEMENT = new PrintElementRestricted("", criteria);
  }
