...
public final class PseudostateKindEnum implements PseudostateKind {
    ...
    public static PseudostateKind forName(java.lang.String name) {
        if (name.equals("pk_choice")) return PK_CHOICE;
        ...
        throw new java.lang.IllegalArgumentException("Unknown literal name '" + name + "' for enumeration 'Data_Types.PseudostateKind'");
    }
    /**
