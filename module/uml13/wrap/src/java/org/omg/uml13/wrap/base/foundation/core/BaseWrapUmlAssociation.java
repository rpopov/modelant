 ...
 */
public abstract class BaseWrapUmlAssociation extends org.omg.uml13.wrap.foundation.core.WrapGeneralizableElement implements org.omg.uml13.foundation.core.UmlAssociation {

  /**
   * Wraps an already existing object into a new wrapper instance
   */
  protected BaseWrapUmlAssociation(java.lang.Object wrapped, Factory factory) {
   ...
   */
  public BaseWrapUmlAssociation(RefPackage extent) {
  ...
  /**
   * This method retrieves the factory for org.omg.uml13.foundation.core.UmlAssociation (also known as "class proxy")
   * model class.
   */
  public static RefClass getClassProxy(RefPackage extent) {
    return ((org.omg.uml13.Uml13Package) extent).getFoundation().getCore().getUmlAssociation();
  }
   ...
   */
  public UmlAssociation getWrapped() {
    return (UmlAssociation) super.getWrapped();
  }

  /**
   * @see net.mdatools.modelant.core.wrap.Wrapper#getDelegate()
   */
  protected UmlAssociation getDelegate() {
    return (UmlAssociation) super.getDelegate();
  }
