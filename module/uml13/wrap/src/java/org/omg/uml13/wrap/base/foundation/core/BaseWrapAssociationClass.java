 ...
 */
public abstract class BaseWrapAssociationClass extends org.omg.uml13.wrap.foundation.core.WrapUmlAssociation implements org.omg.uml13.foundation.core.AssociationClass {

  /**
   * Wraps an already existing object into a new wrapper instance
   */
  protected BaseWrapAssociationClass(java.lang.Object wrapped, Factory factory) {
   ...
   */
  public BaseWrapAssociationClass(RefPackage extent) {
  ...
  /**
   * This method retrieves the factory for org.omg.uml13.foundation.core.AssociationClass (also known as "class proxy")
   * model class.
   */
  public static RefClass getClassProxy(RefPackage extent) {
    return ((org.omg.uml13.Uml13Package) extent).getFoundation().getCore().getAssociationClass();
  }
   ...
   */
  public AssociationClass getWrapped() {
    return (AssociationClass) super.getWrapped();
  }

  /**
   * @see net.mdatools.modelant.core.wrap.Wrapper#getDelegate()
   */
  protected AssociationClass getDelegate() {
    return (AssociationClass) super.getDelegate();
  }
  ...
  /**
   * @see org.omg.uml13.foundation.core.UmlAssociation#getConnection()
   */
