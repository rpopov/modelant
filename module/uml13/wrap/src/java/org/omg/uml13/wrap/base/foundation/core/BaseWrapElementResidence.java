...
import org.omg.uml13.foundation.core.ElementResidence;
 ...
 */
public abstract class BaseWrapElementResidence extends net.mdatools.modelant.core.wrap.Wrapper implements org.omg.uml13.foundation.core.ElementResidence {

  /**
   * Wraps an already existing object into a new wrapper instance
   */
  protected BaseWrapElementResidence(java.lang.Object wrapped, Factory factory) {
   ...
   */
  public BaseWrapElementResidence(RefPackage extent) {
  ...
  /**
   * This method retrieves the factory for org.omg.uml13.foundation.core.ElementResidence (also known as "class proxy")
   * model class.
   */
  public static RefClass getClassProxy(RefPackage extent) {
    return ((org.omg.uml13.Uml13Package) extent).getFoundation().getCore().getElementResidence();
  }
   ...
   */
  public ElementResidence getWrapped() {
    return (ElementResidence) super.getWrapped();
  }

  /**
   * @see net.mdatools.modelant.core.wrap.Wrapper#getDelegate()
   */
  protected ElementResidence getDelegate() {
    return (ElementResidence) super.getDelegate();
  }
  ...
  /**
   * @see org.omg.uml13.foundation.core.ElementResidence#getImplementationLocation()
   */
  public org.omg.uml13.foundation.core.Component getImplementationLocation() {
    return getDelegate().getImplementationLocation();
  }

  /**
   * @see org.omg.uml13.foundation.core.ElementResidence#getResident()
   */
  ...
  /**
   * @see org.omg.uml13.foundation.core.ElementResidence#getVisibility()
   */
  ...
  /**
   * @see org.omg.uml13.foundation.core.ElementResidence#setImplementationLocation(org.omg.uml13.foundation.core.Component)
   */
  public void setImplementationLocation(org.omg.uml13.foundation.core.Component arg0) {
    getDelegate().setImplementationLocation(arg0);
  }

  /**
   * @see org.omg.uml13.foundation.core.ElementResidence#setResident(org.omg.uml13.foundation.core.ModelElement)
   */
  public void setResident(org.omg.uml13.foundation.core.ModelElement arg0) {
    getDelegate().setResident(arg0);
  }

  /**
   * @see org.omg.uml13.foundation.core.ElementResidence#setVisibility(org.omg.uml13.foundation.datatypes.VisibilityKind)
   */
