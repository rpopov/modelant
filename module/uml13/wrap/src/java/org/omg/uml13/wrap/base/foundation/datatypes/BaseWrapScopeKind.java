 ...
 */
public abstract class BaseWrapScopeKind extends net.mdatools.modelant.core.wrap.Wrapper {

  protected BaseWrapScopeKind(java.lang.Object wrapped, Factory factory) {
    super( wrapped, factory );
  }

  protected BaseWrapScopeKind(String value, Factory factory) {
    this( org.omg.uml13.foundation.datatypes.ScopeKindEnum.forName( value ), factory );
  }
   ...
   */
  public ScopeKind getWrapped() {
    return (ScopeKind) super.getWrapped();
  }

  /**
   * @see net.mdatools.modelant.core.wrap.Wrapper#getDelegate()
   */
  protected ScopeKind getDelegate() {
    return (ScopeKind) super.getDelegate();
  }
