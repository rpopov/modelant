...
/**
 * This is a wrapper of org.omg.uml13.modelmanagement.Subsystem that allows adding specific
 * custom methods and using them as templates for [code] generation.
 */
public abstract class BaseWrapSubsystem extends org.omg.uml13.wrap.modelmanagement.WrapUmlPackage implements org.omg.uml13.modelmanagement.Subsystem {

  /**
   * Wraps an already existing object into a new wrapper instance
   */
  protected BaseWrapSubsystem(java.lang.Object wrapped, Factory factory) {
   ...
   */
  public BaseWrapSubsystem(RefPackage extent) {
  ...
  /**
   * This method retrieves the factory for org.omg.uml13.modelmanagement.Subsystem (also known as "class proxy")
   * model class.
   */
  public static RefClass getClassProxy(RefPackage extent) {
    return ((org.omg.uml13.Uml13Package) extent).getModelManagement().getSubsystem();
  }
   ...
   */
  public Subsystem getWrapped() {
    return (Subsystem) super.getWrapped();
  }

  /**
   * @see net.mdatools.modelant.core.wrap.Wrapper#getDelegate()
   */
  protected Subsystem getDelegate() {
    return (Subsystem) super.getDelegate();
  }
  ...
  /**
   * @see org.omg.uml13.modelmanagement.Subsystem#isInstantiable()
   */
  public boolean isInstantiable() {
    return getDelegate().isInstantiable();
  }
  ...
  /**
   * @see org.omg.uml13.modelmanagement.UmlPackage#getElementImport()
   */
  public java.util.Collection getElementImport() {
    return getDelegate().getElementImport();
  }
  ...
  /**
   * @see org.omg.uml13.modelmanagement.Subsystem#setInstantiable(boolean)
   */
  public void setInstantiable(boolean arg0) {
    getDelegate().setInstantiable(arg0);
  }
}