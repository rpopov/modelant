 ...
 */
public abstract class BaseWrapUmlPackage extends org.omg.uml13.wrap.foundation.core.WrapGeneralizableElement implements org.omg.uml13.modelmanagement.UmlPackage {

  /**
   * Wraps an already existing object into a new wrapper instance
   */
  protected BaseWrapUmlPackage(java.lang.Object wrapped, Factory factory) {
   ...
   */
  public BaseWrapUmlPackage(RefPackage extent) {
  ...
  /**
   * This method retrieves the factory for org.omg.uml13.modelmanagement.UmlPackage (also known as "class proxy")
   * model class.
   */
  public static RefClass getClassProxy(RefPackage extent) {
    return ((org.omg.uml13.Uml13Package) extent).getModelManagement().getUmlPackage();
  }
   ...
   */
  public UmlPackage getWrapped() {
    return (UmlPackage) super.getWrapped();
  }

  /**
   * @see net.mdatools.modelant.core.wrap.Wrapper#getDelegate()
   */
  protected UmlPackage getDelegate() {
    return (UmlPackage) super.getDelegate();
  }
