 ...
 */
public abstract class BaseWrapMultiplicityRange extends net.mdatools.modelant.core.wrap.Wrapper implements org.omg.uml13.foundation.datatypes.MultiplicityRange {

  /**
   * Wraps an already existing object into a new wrapper instance
   */
  protected BaseWrapMultiplicityRange(java.lang.Object wrapped, Factory factory) {
   ...
   */
  public BaseWrapMultiplicityRange(RefPackage extent) {
  ...
  /**
   * This method retrieves the factory for org.omg.uml13.foundation.datatypes.MultiplicityRange (also known as "class proxy")
   * model class.
   */
  public static RefClass getClassProxy(RefPackage extent) {
    return ((org.omg.uml13.Uml13Package) extent).getFoundation().getDataTypes().getMultiplicityRange();
  }
   ...
   */
  public MultiplicityRange getWrapped() {
    return (MultiplicityRange) super.getWrapped();
  }

  /**
   * @see net.mdatools.modelant.core.wrap.Wrapper#getDelegate()
   */
  protected MultiplicityRange getDelegate() {
    return (MultiplicityRange) super.getDelegate();
  }
  ...
  /**
   * @see org.omg.uml13.foundation.datatypes.MultiplicityRange#getLower()
   */
  public int getLower() {
    return getDelegate().getLower();
  }

  /**
   * @see org.omg.uml13.foundation.datatypes.MultiplicityRange#getUpper()
   */
  public int getUpper() {
    return getDelegate().getUpper();
  }
  ...
  /**
   * @see org.omg.uml13.foundation.datatypes.MultiplicityRange#getMultiplicity()
   */
  ...
  /**
   * @see org.omg.uml13.foundation.datatypes.MultiplicityRange#setLower(int)
   */
  public void setLower(int arg0) {
    getDelegate().setLower(arg0);
  }

  /**
   * @see org.omg.uml13.foundation.datatypes.MultiplicityRange#setMultiplicity(org.omg.uml13.foundation.datatypes.Multiplicity)
   */
  ...
  /**
   * @see org.omg.uml13.foundation.datatypes.MultiplicityRange#setUpper(int)
   */
  public void setUpper(int arg0) {
    getDelegate().setUpper(arg0);
  }
}