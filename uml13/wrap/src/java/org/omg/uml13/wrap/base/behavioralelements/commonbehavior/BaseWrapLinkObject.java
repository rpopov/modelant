...
import org.omg.uml13.behavioralelements.commonbehavior.LinkObject;
import net.mdatools.modelant.core.wrap.Factory;
import net.mdatools.modelant.core.wrap.Factories;

/**
 * This is a wrapper of org.omg.uml13.behavioralelements.commonbehavior.LinkObject that allows adding specific
 * custom methods and using them as templates for [code] generation.
 */
public abstract class BaseWrapLinkObject extends org.omg.uml13.wrap.behavioralelements.commonbehavior.WrapObject implements org.omg.uml13.behavioralelements.commonbehavior.LinkObject {

  /**
   * Wraps an already existing object into a new wrapper instance
   */
  protected BaseWrapLinkObject(java.lang.Object wrapped, Factory factory) {
   ...
   */
  public BaseWrapLinkObject(RefPackage extent) {
  ...
  /**
   * This method retrieves the factory for org.omg.uml13.behavioralelements.commonbehavior.LinkObject (also known as "class proxy")
   * model class.
   */
  public static RefClass getClassProxy(RefPackage extent) {
    return ((org.omg.uml13.Uml13Package) extent).getBehavioralElements().getCommonBehavior().getLinkObject();
  }
   ...
   */
  public LinkObject getWrapped() {
    return (LinkObject) super.getWrapped();
  }

  /**
   * @see net.mdatools.modelant.core.wrap.Wrapper#getDelegate()
   */
  protected LinkObject getDelegate() {
    return (LinkObject) super.getDelegate();
  }
