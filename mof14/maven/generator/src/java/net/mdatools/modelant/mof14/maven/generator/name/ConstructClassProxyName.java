...
/**
 * Construct a Package Interface name, as of JMI 1.0 Specification, Section 4.8.2
 * @author Rusi Popov
 */
public class ConstructClassProxyName implements ConstructName {
   ...
   */
  public ConstructClassProxyName(ConstructName decorated) {
  ...
  public String constructName(ModelElement element) {
    return decorated.constructName( element )+"Class";
  }
