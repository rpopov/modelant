 ...
 * @author Rusi Popov
 */
public class <%=className %> extends Factory {
...
%>    mapModelToWrapper.put(<%=wrapper.calculateQualifiedClassName() %>.class,<%=wrapper.calculateQualifiedWrapperClassName( wrapperPackage ) %>.class);
<%
   }
%>  }
  ...
  protected Class<?>[] getMappedRootClasses() {
    return mapModelToWrapper.keySet().toArray( new Class[] {} );
  }
}